...
export const MainContextProvider = ({ children }) => {
	...
	useEffect(() => {
		...
		// 	setHotels(
		// 		data?.filter(
		// 			(hotel) => hotel.name && hotel.location_id != 0 && hotel.rating > 0
		// 		)
		// 	);
		// });
		// 	} catch (error) {
